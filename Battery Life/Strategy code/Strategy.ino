...
#define WIFI_PASSWORD "dH;94Sb[r=" // Replace with your network password

#define DATABASE_SECRET "AIzaSyBiLHdWr25XcA_DpuaS82BDVZ7Zci4byGE" // Replace with your database URL
#define DATABASE_URL "https://lab-5-434ed-default-rtdb.firebaseio.com" // Replace with your API key
...
int uploadInterval = 5000; // 1 seconds each upload
...
void setup(){
  ...
  WiFi.disconnect();
  esp_sleep_enable_timer_wakeup(30000 * 1000); // in microseconds
